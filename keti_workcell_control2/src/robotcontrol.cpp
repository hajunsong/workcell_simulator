...
void RobotControl::init(ros::NodeHandle nh){
...
//	ROS_INFO("[UR] current joint position : %f, %f, %f, %f, %f, %f", msg->position[0], msg->position[1], msg->position[2], msg->position[3], msg->position[4], msg->position[5]);
	std::copy(msg->position.begin(), msg->position.end(), jntUR.begin());
}

void RobotControl::cbJointStateARF(const sensor_msgs::JointStatePtr &msg){
//	ROS_INFO("[ARF] current joint position : %f, %f, %f, %f, %f, %f", msg->position[0], msg->position[1], msg->position[2], msg->position[3], msg->position[4], msg->position[5]);
	std::copy(msg->position.begin(), msg->position.end(), jntARF.begin());
}

void RobotControl::cbJointStateDENSO(const sensor_msgs::JointStatePtr &msg){
//	ROS_INFO("[DENSO] current joint position : %f, %f, %f, %f, %f, %f", msg->position[0], msg->position[1], msg->position[2], msg->position[3], msg->position[4], msg->position[5]);
	std::copy(msg->position.begin(), msg->position.end(), jntDENSO.begin());
}
...
void RobotControl::getJointUR(std::vector<double> arg){
	std::copy(jntUR.begin(), jntUR.end(), arg.begin());
}

void RobotControl::getJointARF(std::vector<double> arg){
	std::copy(jntARF.begin(), jntARF.end(), arg.begin());
}

void RobotControl::getJointDENSO(std::vector<double> arg){
	std::copy(jntDENSO.begin(), jntDENSO.end(), arg.begin());
}
