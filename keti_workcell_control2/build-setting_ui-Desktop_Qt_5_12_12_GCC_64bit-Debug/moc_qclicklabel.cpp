...
#include "../setting_ui/qclicklabel.h"
...
QT_MOC_LITERAL(4, 40, 8) // "mousePos"

    },
    "QClickLabel\0mousePressed\0\0mouseReleased\0"
    "mousePos"
};
...
void QClickLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QClickLabel::mousePressed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QClickLabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QClickLabel::mouseReleased)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QClickLabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QClickLabel::mousePos)) {
                *result = 2;
                return;
            }
        }
